...
var idx = 0;
var portfolio = ['<div id="popcorn" class="container-fluid portfolio-container"> <div class="row"> <div class="col-md-12 navigator"> <a id="decrement"><img src="/images/arrow-left.png" class="arrows left-arrow"></a><img src="/images/popcorn-logo.png" class="ma-and-pa-main-image"><a id="increment"><img src="/images/arrow-right.png" class="arrows right-arrow"/></a></div></div> <div class="row"> <div class="col-md-12"> <h1 class="main-project-title">Popcorn Shop</h1> </div> </div> <div class="row app-img-row"> <div class="col-md-4 app-img-col"> <img src="/images/mapa-login.png" class="app-img float-right" id="app-img-seven"> </div> <div class="col-md-4 app-img-col"> <img src="/images/mapa-shop.png" class="app-img" id="app-img-eight"> </div> <div class="col-md-4 app-img-col"> <img src="/images/mapa-products.png" class="app-img float-left" id="app-img-nine"> </div> </div> <div class="row app-img-row"> <div class="col-md-4 app-img-col"> <img src="/images/mapa-cart.png" class="app-img float-right" id="app-img-ten"> </div> <div class="col-md-4 app-img-col"> <img src="/images/mapa-blue.png" class="app-img" id="app-img-eleven"> </div> <div class="col-md-4 app-img-col"> <img src="/images/mapa-form.png" class="app-img float-left" id="app-img-twelve"> </div> </div></div>',
