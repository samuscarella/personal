...
$(document).ready(function() {
    ...
    document.getElementById('social-icon-one').onclick = function () {
        FB.ui({
            method: 'share',
            display: 'popup',
